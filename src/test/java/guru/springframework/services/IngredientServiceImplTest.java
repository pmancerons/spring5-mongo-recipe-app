...
public class IngredientServiceImplTest {
    ...
    public void findByRecipeIdAndReceipeIdHappyPath() throws Exception {
        ...
        //then
        Mono<IngredientCommand> ingredientCommandMono = ingredientService.findByRecipeIdAndIngredientId("1", "3");
    ...
    public void testSaveRecipeCommand() throws Exception {
        ...
        //when
        Mono<IngredientCommand> ingredientMono = ingredientService.saveIngredientCommand(command);
